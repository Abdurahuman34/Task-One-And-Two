...
# Create an array name of frutits 
fruits = ["apple", "banana", "cherry", "date", "fig", "grape"]

# Print the entire array use puts before your varible 
puts fruits

# Print the first and last elements of the array.
# apositve array starts from 0

puts fruits[0]
puts fruits[5]

# Add "kiwi" to the end of the array 
# use the .push to add a fruite name 
fruits.push("kiwi")

# Remove "cherry" from the array
# use the .delete after the your variable 
...
# use if statement and pass a value with method objects 
...
# pass the varibale as a string interpolations in quotes puts before it
print "Enter a fruit: "
